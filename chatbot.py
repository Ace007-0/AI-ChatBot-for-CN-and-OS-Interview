...
# 🥔 Funny function for testing
def launch_to_mars():
    print("🚀 Launching a potato to Mars... Done! 🥔🪐")


# Main logic
if __name__ == '__main__':
    model_file = 'chatbot_model.pth'
    metadata_file = 'dimensions.json'
    train_mode = True  # Set to True to train, False to just run the bot
    ...
    if train_mode:
        ...
        assistant.save_model(model_file, metadata_file)

    assistant = ChatbotAssistant('intents.json', function_mappings={'launch_to_mars': launch_to_mars})
    assistant.load_model(model_file, metadata_file)
